...
\begin{frame}
\frametitle{Conceptually} An Eden channel connects the outport of a
process with an inport of a receiver process.  The channel consists of
a writing end and a placeholder for reading.

\pause

Each machine runs a process, consisting of multiple threads, with a
1:1 relation between threads and outports.

\pause

Sending is explicit, receiving is implicit.
